...
<body>
	...
	<form  method="post" action="${contextPath}/member170202/modMember.do">
	<%-- <form  method="post" action="${contextPath}/member170202/modMember.do?id=${memInfo.id}"> --%>
		<table align="center" >
			<tr>
			...
			<tr>
				...
				<td width="400"><input type="text" name="name" value="${memInfo.name}" disabled></td>
			</tr>
			<tr>
