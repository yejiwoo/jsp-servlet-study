		...
		try {
			...
			if((action == null) || 
			   ...
			   (action.equals("/listArticles.do"))) {
				...
				pw.print("<script>" 
				         +" alert('새글을 추가했습니다.');" 
						 +" location.href='"+request.getContextPath()+"/board170306/listArticles.do';"
				         +"</script>");
			 ...
			 //수정된 사용자의 글을 데이터베이스에 저장시킵니다. 
				...
				pw.print("<script>" 
				         ...
				         +"/board170306/viewArticle.do?articleNO="+ articleNO + "';"
				         +"</script>");
				return;
