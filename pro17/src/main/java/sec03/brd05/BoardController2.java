		...
		try {
			...
			if((action == null) || 
			   ...
			   (action.equals("/listArticles.do"))) {
				...
				nextPage = "/board04/listArticles2.jsp";
				
			}//글쓰기 창을 호출
			 else if (action.equals("/articleForm.do")) {
				nextPage = "/board04/articleForm2.jsp";
				...
				pw.print("<script>" 
				         +" alert('새글을 추가했습니다.');" 
						 +" location.href='"+request.getContextPath()+"/board1703052/listArticles.do';"
				         +"</script>");
				...
				//호출(포워딩)페이지 이름 저장
				nextPage = "/board04/viewArticle2.jsp";
			  ...
			  //수정된 사용자의 글을 데이터베이스에 저장시킵니다. 
				...
				pw.print("<script>" 
				         ...
				         +"/board1703052/viewArticle.do?articleNO="+ articleNO + "';"
				         +"</script>");
				return;
