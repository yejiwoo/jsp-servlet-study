...
<body>
					...
					<td align='left'  width="35%">
						...
						<c:choose>
							<c:when test="${article.level > 1}">
								...
								<!-- 공백 다음에 자식 글을 표시합니다. -->
								<a class="cls1" href="${contextPath}/board170305/viewArticle.do?articleNO=${article.articleNO}">${article.title}</a>
							</c:when>
							<c:otherwise>
								<a class="cls1" href="${contextPath}/board170305/viewArticle.do?articleNO=${article.articleNO}">${article.title}</a>
							</c:otherwise>
	...
	<div style="text-align:center; font-size:30px;">
		<p>board170305 서브릿 용</p>
		<a style="text-decoration:none;" 
		   href="${contextPath}/board170305/articleForm.do">글쓰기</a></div>
</body>
</html>