...
<head>
	...
	<script src="http://code.jquery.com/jquery-latest.min.js"></script>
		...
		function modifyArticle(obj){
			obj.action="${contextPath}/board170307/modArticle.do";
			obj.submit();
		}
		...
		function removeArticle(articleNO){
			...
			sendform.setAttribute("action", "${contextPath}/board170307/removeArticle.do");
		...
		function callReplyForm(){
			...
			sendform2.setAttribute("action", "${contextPath}/board170307/replyForm.do?parentNO=${articleVO.articleNO}");
