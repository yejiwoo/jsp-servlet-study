...
<head>
	...
	<script type="text/javascript">
		...
		function backToList(obj){
			//obj.action="${contextPath}/board170302/listArticles.do";
			obj.action="${contextPath}/board170303/listArticles.do";
			obj.submit();
		}
	</script>
 	<style>
...
<body>
	...
	<form name="articleForm" method="post" 
			<%-- action="${contextPath}/board170302/addArticle.do" --%> 
			action="${contextPath}/board170303/addArticle.do"
