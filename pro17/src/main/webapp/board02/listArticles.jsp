...
<body>
					...
					<td align='left'  width="35%">
						...
						<c:choose>
							<c:when test="${article.level > 1 }">
								...
								<!-- 공백 다음에 자식 글을 표시합니다. -->
								<%-- <a class="cls1" href="${contextPath}/board170302/viewArticle.do?articleNO=${article.articleNO}">${article.title}</a> --%>
								<a class="cls1" href="${contextPath}/board170303/viewArticle.do?articleNO=${article.articleNO}">${article.title}</a>
							</c:when>
							<c:otherwise>
								<%-- <a class="cls1" href="${contextPath}/board170302/viewArticle.do?articleNO=${article.articleNO}">${article.title}</a> --%>
								<a class="cls1" href="${contextPath}/board170303/viewArticle.do?articleNO=${article.articleNO}">${article.title}</a>
	...
	<div style="text-align:center; font-size:30px;">
		<p>board170302 서브릿 용</p>
		<a style="text-decoration:none;" 
		   href="${contextPath}/board170302/articleForm.do">글쓰기</a></div>
		<hr>
	<div style="text-align:center; font-size:30px;">
		<p>board170303 서브릿 용</p>
		<a style="text-decoration:none;" 
		   href="${contextPath}/board170303/articleForm.do">글쓰기</a></div>
</body>
</html>