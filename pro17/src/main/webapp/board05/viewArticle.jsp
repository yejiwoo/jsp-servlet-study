...
<body>
	...
	<script type="text/javascript">
		function backToList(obj){
			obj.action="${contextPath}/board170306/listArticles.do";
			obj.submit();
		}
		...
		function modifyArticle(obj){
			obj.action="${contextPath}/board170306/modArticle.do";
			obj.submit();
		}
/*
		function removeArticle(obj){
			obj.action="${contextPath}/board170306/removeArticle.do";
			obj.submit();
		}
*/
		...
		function removeArticle(articleNO){
			...
			sendform.setAttribute("action", "${contextPath}/board170306/removeArticle.do");
...
<!--  -->
			...
			<tr id="tr_btn">
				<td colspan=2 >
					...
					<%-- <input type=button value="삭제하기" onClick="removeArticle('${contextPath}/board170306/removeArticle.do', ${article.articleNO})"> --%>
